<p align="center">
  <img src="media/demo.gif" alt="UnType Demo" width="800">
</p>
...
[English](README_EN.md) · [报告问题](https://github.com/jlmaoju/UnType/issues) · [功能建议](https://github.com/jlmaoju/UnType/discussions)

---

**UnType** 是一个开源的 AI 语音输入工具（Windows）。它不只是转录——它会**思考**。

> 别的语音输入：把你说的话变成文字，充满"嗯""啊"和标点错误
>
> **UnType：把你的想法变成干净的文稿**
...
按 **F6** → 说话 → 再按 **F6** → 润色好的文字出现在光标处

**核心差异：STT + LLM**
```
你的语音 → STT 转录 → LLM 润色 → 干净的文字
  "嗯那个我想请问一下这个产品什么时候发货呀"
                ↓
        "请问这个产品什么时候发货？"
```
...
按 F6，说出你想写的内容，松开后润色好的文字自动出现在光标位置。

```
你说: "帮我写个请假条就说我家里有点事需要请一天假"
输出: "您好，因家中临时有事，需请假一天，望批准。"
```

### 2️⃣ 选中即润色

选中已有文字，说出修改指令，AI 帮你改写。
